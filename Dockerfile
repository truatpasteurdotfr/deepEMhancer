...
RUN	\
	...
	conda env config vars set LD_LIBRARY_PATH=${CONDA_PREFIX}/lib/python3.9/site-packages/nvidia/cudnn/lib:${CONDA_PREFIX}/lib/:/.singularity.d/libs:$LD_LIBRARY_PATH && \
	conda activate deepEMhancer_env && \
